...
namespace HOKM.Code
{
    internal class Test
    {
        ...
        public static void Mmain(string[] args)
        {
            ...
            // Determine Strong:
            //strong = REAL_STARTEGY.GetStrong(sock);
            ...
            while (isGame)
            {
                ...
                //REAL_STARTEGY.Discover(turn, playedCards, card_history);
            }
        ...
        public static string DoTurn(Socket sock)
        {
            ...
            //Card selected = REAL_STARTEGY.DoTurn(suit, strong, points[0], points[1], played_cards, counter, pack, card_history);
            // Algorithm
